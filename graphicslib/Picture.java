...
public class Picture implements Shape
{
   ...
   public Picture(double width, double height)
   {
    ...
    public void setWidth(int width) {
      xGrow = (width - (image == null ? 0 : image.getWidth())) / 2;
      Canvas.getInstance().repaint();
    }
    ...
    public void setHeight(int height) {
      yGrow = (height - (image == null ? 0 : image.getHeight())) / 2;
      Canvas.getInstance().repaint();
    }
     ...
     * @return the new color for the pixel
     */
    ...
    /**
     * Scales this picture proportionally
